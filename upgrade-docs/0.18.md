...
You can use [elm-upgrade](https://github.com/avh4/elm-upgrade#elm-upgrade) to have many of these steps performed for you automatically: first install [elm-format](https://github.com/avh4/elm-format#installation-) and then run the following in your terminal:
